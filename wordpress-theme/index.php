...
<body <?php body_class(); ?>>
  ...
  <div class="top-notice-bar">
    <div class="container-wide notice-flex">
      ...
      <div style="display: flex; align-items: center; gap: 1rem; color: #94A3B8; font-size: 0.8rem;">
        ...
        <span style="color: rgba(255, 255, 255, 0.4);">|</span>
        <span id="live-ticker-time" style="font-family: var(--font-mono); color: #F8FAFC;">23:41:37</span>
      </div>
    </div>
  </div>
  ...
  <header class="editorial-header">
    <div class="container-wide header-flex">
      ...
      <nav style="display: flex; gap: 1.75rem; align-items: center; font-size: 0.925rem; font-weight: 500;">
        ...
        <a href="#case-study-real" class="nav-link">Keshav's Story</a>
  ...
  <main class="container-wide">
    ...
    <!-- HERO SECTION: The Honest Founder Truth -->
    <section id="hero-story" class="hero-section">
      ...
      <div style="display: flex; gap: 1.25rem; justify-content: center; align-items: center; margin-bottom: 4rem;">
        ...
        <a href="#case-study-real" class="btn-cta-secondary" style="padding: 1.1rem 2.5rem; font-size: 1.05rem;">Read Keshav's Real Founder Story ↓</a>
      </div>
    ...
    <section class="proof-bar">
      <div class="proof-card">
        <div class="proof-grid">
          <div>
            <div class="proof-val counter-val" data-target="100" data-prefix="" data-suffix="%" style="color: var(--accent-gold);">100%</div>
            <div class="proof-label">Deterministic Output Accuracy</div>
          </div>
          <div>
            <div class="proof-val counter-val" data-target="0" data-prefix="" data-suffix=" Hallucinations" style="color: var(--text-primary);">0 Hallucinations</div>
            <div class="proof-label">Governed Context Engine</div>
          </div>
          <div>
            <div class="proof-val counter-val" data-target="0" data-prefix="" data-suffix=" Vendor Taxes" style="color: var(--accent-emerald);">0 Vendor Taxes</div>
            <div class="proof-label">Free Direct Meta WABA Keys</div>
          </div>
          <div>
            <div class="proof-val counter-val" data-target="0" data-prefix="" data-suffix=" Account Bans" style="color: var(--accent-emerald);">0 Bans</div>
            <div class="proof-label">100% Official Meta Compliance</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- SECTION 3: KESHAV'S REAL FOUNDER STORY (ZERO AI SLOP) -->
    <section id="case-study-real" class="section-wrap">
      <article class="editorial-case-study">
        
        <header style="text-align: center; margin-bottom: 4rem;">
          <span class="bento-badge badge-emerald" style="font-size: 0.85rem; padding: 0.45rem 1.35rem;">THE TRUE FOUNDER STORY</span>
          <h2 style="font-size: 2.85rem; color: var(--text-primary); margin-top: 0.85rem; line-height: 1.2;">
            Why I Stopped Building AI Agents And Built Custom Harnesses Instead
          </h2>
          <p style="font-size: 1.15rem; color: var(--text-secondary); max-width: 760px; margin: 1.15rem auto 0;">
            The authentic story of Keshav Kumar: trying to help my father's business, watching generic AI agents hallucinate, and engineering the Custom Agent Harness.
          </p>
        </header>
        ...
        <div class="cs-narrative" style="max-width: 820px; margin: 0 auto; font-size: 1.15rem; line-height: 1.9; color: #1e293b;">
          ...
          <h3 style="font-size: 1.7rem; color: var(--text-primary); margin-bottom: 1.15rem;">1. Seeing The Operational Bottleneck</h3>

          <p>
            I saw my father struggling with his business operations every single day. Managing customer accounts, tracking balances, and doing manual follow-ups was taking an enormous amount of time and effort, while money remained trapped in the market.
          </p>

          <p>
            At the same time, I saw everyone on the internet selling AI—marketing that <em>"AI can do everything and automate your whole company."</em> But whenever people tried applying AI to real work tasks, it failed.
          </p>

          <h3 style="font-size: 1.7rem; color: var(--text-primary); margin: 2.75rem 0 1.15rem;">2. The Agent Experiment & The Hallucination Cascade</h3>

          <p>
            I had already been studying AI for a year out of personal interest. So I thought, <em>"Let me help my father. Building an AI agent will simply solve this problem."</em>
          </p>

          <p>
            I got the official Meta API for free directly from Meta and built the agent. I tried using Claude, Custom GPTs, and popular agent frameworks thinking, <em>"This simply should work out of the box."</em>
          </p>

          <p>
            <strong>It didn't work. The agent hallucinated.</strong>
          </p>

          <p>
            The moment real business data hit the agent, one hallucination triggered a <strong>cascade of errors</strong>:
          </p>

          <ul style="padding-left: 1.5rem; margin-bottom: 2.5rem;">
            <li style="margin-bottom: 0.85rem;">Fixing one bug caused three more bugs to appear immediately.</li>
            <li style="margin-bottom: 0.85rem;">Data got mismatched, sending wrong numbers and messages to clients.</li>
            <li style="margin-bottom: 0.85rem;">Multiple duplicate spam messages fired, angering customers and creating confusion.</li>
          </ul>
          ...
          <figure style="margin: 3.5rem 0; padding: 2.25rem 0; border-top: 1px solid var(--border-light); border-bottom: 1px solid var(--border-light); text-align: center;">
            <blockquote style="font-family: var(--font-serif); font-style: italic; font-size: 1.85rem; line-height: 1.4; color: var(--text-primary); margin-bottom: 1rem;">
              "AI in business wasn't working because companies built products saying AI can do everything. But in real tasks, one hallucination fails everything, leading from one bug to another bug cascade."
            </blockquote>
            <figcaption style="font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--text-muted);">&mdash; Keshav Kumar, Systems Architect</figcaption>
          </figure>

          <h3 style="font-size: 1.7rem; color: var(--text-primary); margin: 2.75rem 0 1.15rem;">3. The Breakthrough: Building A Custom Harness</h3>

          <p>
            That was my breakthrough. I realized: <strong>You cannot solve real business tasks by just launching generic AI agents. Agents are probabilistic—they guess.</strong>
          </p>

          <p>
            I stopped trying to build unconstrained agents and engineered a **Custom Agent Harness** instead:
          </p>

          <ul style="padding-left: 1.5rem; margin-bottom: 2.5rem;">
            <li style="margin-bottom: 0.85rem;"><strong>Strict File Context (ICM + OKF):</strong> Instead of letting the AI guess, I governed its context using plain-text sovereign files (`.md`). The rules were clear, transparent, and completely controllable.</li>
            <li style="margin-bottom: 0.85rem;"><strong>Direct Meta API Integration:</strong> Connected directly to Meta's official Cloud API for 0% ban risk and zero third-party vendor markups.</li>
            <li style="margin-bottom: 0.85rem;"><strong>Smart Failure & Escalation:</strong> If any dispute or edge case occurred, the harness safely paused and routed the issue to a human.</li>
          </ul>

          <h3 style="font-size: 1.7rem; color: var(--text-primary); margin: 2.75rem 0 1.15rem;">4. Real Positive Results & Building For Others</h3>

          <p>
            The moment the Custom Harness was deployed, the hallucinations stopped, the bug cascades vanished, and my father's business got <strong>real, positive results</strong>. Cash flow was unblocked, operations ran smoothly, and follow-ups happened automatically with 100% accuracy.
          </p>

          <p>
            After seeing how a custom harness transformed my father's operations, I realized that countess other business owners are struggling with the exact same AI hype and broken automations.
          </p>

          <p>
            Today, I build <strong>Custom Agent Harnesses</strong> for business owners—working directly with them to solve their operational bottlenecks and co-deploying for 30 days to guarantee <strong>Desired Business Output</strong>.
          </p>
        ...
        <div class="playground-grid">
          ...
          <div class="playground-controls">
            ...
            <div class="control-group">
              ...
              <input type="text" id="playground-client-name" class="control-input" value="Rajesh Hardware">
            </div>
...
5. CONFUSING DATA: Alert owner on WhatsApp and isolate corrupt record immediately.</pre>
      </div>
    </section>

    <!-- SECTION 7: DSO & ROI CALCULATOR -->
    <section id="calculator" class="section-wrap">
      <h2 class="section-title">Days Sales Outstanding (DSO) & ROI Calculator</h2>
      <p class="section-sub">Calculate your unlocked working capital, DSO acceleration, and annual interest loan savings by eliminating manual debt collection.</p>
      ...
      <div class="calc-box">
        ...
        <div class="calc-result-grid">
          <div>
            <div style="font-size: 0.85rem; color: #94A3B8; margin-bottom: 0.35rem; text-transform: uppercase; font-weight: 600;">Working Capital Unlocked</div>
            <div class="calc-result-val" id="calc-unlocked-cash">₹20.00 Lakhs</div>
          </div>
          <div>
            <div style="font-size: 0.85rem; color: #94A3B8; margin-bottom: 0.35rem; text-transform: uppercase; font-weight: 600;">Collection Velocity</div>
            <div class="calc-result-val" id="calc-dso-reduced" style="color: var(--accent-gold-bright);">45d → 27d</div>
          </div>
          <div>
            <div style="font-size: 0.85rem; color: #94A3B8; margin-bottom: 0.35rem; text-transform: uppercase; font-weight: 600;">Annual Loan Interest Saved (12%)</div>
            <div class="calc-result-val" id="calc-interest-saved" style="color: #60A5FA;">₹2.40 Lakhs/yr</div>
          </div>
        </div>
      </div>
    </section>

    <!-- SECTION 8: FAQ WITH SEARCH -->
